// @ts-check
/**
 * @file GhostPlayerEntityDeserializer.js
 * @description Client-side deserializer for GHOST_PLAYER entity type.
 * Mirrors server/game/entities/GhostPlayerEntity.cpp serialization.
 *
...
/**
 * Deserialize ghost player entity update.
